...
| 数据 | 记录数 | 来源 |
| --- | ---: | --- |
| 设备 / 心跳 / 日志 /读数 | 7 / 12 / 18 / 12 | 历史阶段测试、模拟器、验收及 `demo-ui-` 设备 |
...
| 合成用户 / 课程 / 班级 / 角色 / 设备绑定 | 2 / 1 / 1 / 5 / 1 | `demo-ui-` 页面登录测试数据 |
| 正式用户 / 正式课程 / 正式班级 | 全部 0 | 等待正式名单与授权 |
...
4. 可授权知识文件、来源 URI、版本、适用硬件、许可证，以及知识整理员和正式批准人的
   审核结论。
